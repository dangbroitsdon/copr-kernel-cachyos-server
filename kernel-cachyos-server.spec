...
Provides:       kernel-cachyos-server > 6.12.9-cb1.0%{?_lto_args:.lto}%{?dist}
Provides:       installonlypkg(kernel)
Obsoletes:      kernel-cachyos-server <= 6.12.9-cb1.0%{?_lto_args:.lto}%{?dist}
...
%package core
Summary:        Linux EEVDF Cachy Sauce Kernel by CachyOS with other patches and improvements
AutoReq:        no
